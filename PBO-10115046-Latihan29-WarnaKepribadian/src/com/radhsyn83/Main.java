...
public class Main {
    ...
    static String[] warnaBackground = {"\033[0;101m", "\033[0;102m", "\033[0;103m", "\033[0;104m", "\033[0;105m", "\033[0;106m"};
    static String[] warnaNama = {"Merah", "Hijau", "Kuning", "Biru", "Ungu", "Cyan"};
    ...
    private static void pribadiMerah() {
    ...
    private static void pribadiHijau() {
    ...
    private static void pribadiKuning() {
    ...
    private static void pribadiBiru() {
    ...
    private static void pribadiUngu() {
